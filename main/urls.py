...
from main.views import show_main,add_product,product_list, show_product, score_board, show_xml, show_json, show_json_by_id, show_xml_by_id, register, login_user, logout_user
